...
- Научному руководителю Кочергину И.И. за методологическое сопровождение работы
- Рецензенту Кобылкину Н.Н.
- Преподавателям программы «ЛигалТех» НИУ ВШЭ
- Команде NextGIS за стабильный API доступа к данным Росреестра
- Команде OpenRouter за единый шлюз к LLM-моделям
- Сообществу open-source — Leaflet, FastAPI, pdfplumber и десятки других проектов, на которых построен PlotFinder
